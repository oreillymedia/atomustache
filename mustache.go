...
// Completely and utterly stolen from 
// https://github.com/hoisie/mustache
// It's not maintained, and I needed a quick 
// way to pass an array of partials to render function.
...
func RenderInLayout(data string, layoutData string, context ...interface{}) string {
    layoutTmpl, err := ParseString(layoutData, nil)
    if err != nil {
        return err.Error()
    }
    tmpl, err := ParseString(data, nil)
